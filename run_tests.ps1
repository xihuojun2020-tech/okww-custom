...
$groups = @{
  unit = @(
    ...
    "TestAccountRuntimeBootstrap.py", "TestAccountSwitch.py", "TestAutoAbyssTask.py",
    ...
    "TestTaskStatus.py", "TestLogoutCapture.py", "TestDailyTaskStatus.py", "TestStaminaAccounting.py",
    "TestSequenceRepository.py", "TestTestGroups.py", "TestUpstreamCharacterPort.py", "TestWaitLogin.py",
