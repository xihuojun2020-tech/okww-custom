...
from PySide6.QtWidgets import QTableWidgetItem, QWidget, QVBoxLayout, QLabel, QDialog, QPlainTextEdit, QPushButton
...
class TaskTab(Tab):
    def __init__(self):
        ...
        self.task_info_container = self.add_card(self.tr("任务状态"), self.task_summary)
        self.info_details = QPushButton('详细状态', self.task_info_container)
        self.info_details.clicked.connect(self.show_info_details)
        self.task_info_container.add_top_widget(self.info_details)
