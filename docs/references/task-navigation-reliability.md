...
状态：方案与代码盘点完成，尚未全量实施。2026-09-14；盘点基线 `3b75ddf1` / 产品版本 1.70.07。
...
建议工具页显示最近步骤：“来源页不稳定”“第 2/3 次点击”“加载中，剩余预算”“已进入目标页”“结果不明，已停止重复操作”，沿用现有组件与整体风格。诊断状态必须区分截图请求、文件落盘、进入上传队列、上传失败/重试、NAS 校验成功，不能只显示一个“已上传”。本轮仅方案，不宣称已新增 UI。
...
实施文件、分批测试和协作要求见 [实施计划](../superpowers/plans/2026-09-14-task-navigation-reliability.md)。源码方法索引见 [盘点附录](../reviews/2026-09-14-task-navigation-inventory.md)。本轮未修改程序逻辑，也未审阅 NAS ZIP。
