...
本文含多次界面调整的历史记录。当前账号页分组以“账号识别信息、待办提醒、日常与声骸、周常安排、收尾行为、截图与录像、高级账号操作”为准；1.84.00 起待办固定六项并支持每账号备注，待办不进入完成检查、不决定任务执行。当前活动入口见[活动任务](activity-tasks.md)。
...
- 账号：账号识别信息（含所属序列）、待办提醒、日常与声骸、周常安排、收尾行为和高级账号操作。清理体力并入日常与声骸，周本目标与紧凑状态表并入周常安排；任务的“编辑账号计划/序列”跳到此处，不刷新或丢弃草稿。
