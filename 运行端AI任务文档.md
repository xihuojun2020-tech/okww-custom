...
> 目标版本：okww-custom（当前应已更新到 **v1.05.00**）
...
## 5. 任务 E：更新到 v1.05.00 并运行连续账号切换测试（当前任务）

### E1. 更新
1. 通过 GitHub/PyAppify 更新到 **v1.05.00**；
2. 确认 `working\config.py` 为 `version = "1.05.00"`；
