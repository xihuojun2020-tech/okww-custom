...
> 文档版本：2026-08-19 v4（开发端提供）
> 当前适用版本：okww-custom **v1.84.00**。第 7、8 节标题中的 v1.08.00 表示机制最初引入版本；现行账号计划字段与 UI 见 [1.84.00 账号规划说明](docs/references/account-planning-1.84.md)。
