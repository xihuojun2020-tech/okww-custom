...
class TestCodexLightUI(unittest.TestCase):
    ...
    def test_release_version_is_synchronized(self):
        ...
        self.assertEqual(version, "1.19.00")
        self.assertIn("V1.19.00", Path("custom_ok/ok/gui/about/AboutTab.py").read_text(encoding="utf-8"))
        self.assertIn("1.19.00", Path("更新日志.md").read_text(encoding="utf-8"))
