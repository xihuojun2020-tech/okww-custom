<div align="center">
  <p>当前版本：<a href="更新日志.md">1.70.00 全输出角色单人分支</a> · <a href="docs/references/solo-combat.md">单人输出支持清单</a> · <a href="docs/references/completion-evidence.md">完成检查分组与图片复制</a> · <a href="docs/references/material-planner-1.59.md">养成材料规划</a></p>
  <h1 align="center">
